...
X <- data[,1:400] # select variables V1:V400
...
barplot(freq~var_both,
        main="Fuzzy Forest: 50 simulations (n=100)", ylab = 'Frequency of Selection', xlab = 'Variable', las=2)
...
barplot(ff200_freq~ff200_var_both,
        main="Fuzzy Forest: 50 simulations (n=200)", ylab = 'Frequency of Selection', xlab = 'Variable', las=2)
barplot(ff300_freq~ff300_var_both,
        main="Fuzzy Forest: 50 simulations (n=300)", ylab = 'Frequency of Selection', xlab = 'Variable', las=2)
barplot(ff400_freq~ff400_var_both,
        main="Fuzzy Forest: 50 simulations (n=400)", ylab = 'Frequency of Selection', xlab = 'Variable', las=2)
