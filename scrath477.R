...
data <- sim_3(100,5, cor_feature = 0.8)

# alpha 
sim_6 = function(n,T,cor_feature=0.8,var_noise=1,alpha=0.8,a1=5,a2=-5,b1=1,b2=1,c1=-10, c2 =10){
  p = 400
  p0 = 100
  ...
  #                         
  #                         a*(data$time - median(1:T))^2*data$group1 + -a*(data$time - median(1:T))^2*data$group2 +
  #                         b*data$time + c*data$group1 - c*data$group2 +
  #                         
