# Generates training and test dataset of different sizes n*. Trains and tests prediction error for 
# Random Forest, REEM Tree, GLMM Tree, and Long Tree at each value of n. Generates visualization
# of MSE vs. Sample Size (n) for model comparison. 
#
# *this is done as a workaround for longtree and small sample size--current bug cannot have test set
...
ggplot(df_total, aes(x=n, y=MSE)) +
  ...
  labs(title="", subtitle="", y="Mean Squared Error (MSE)", x="Sample Size (n)", caption="")
