# Compares model performance of Random forest, REEM tree, bagging REEM tree, and long tree. Models are not tuned, this
# needs to be addressed. Generate a test set for prediction error calculations. Generate training sets using 
#different sample size n.  Train each model on each sample size and calculate MSE using test set. Create visualization
# of MSE vs Sample size (n). 
